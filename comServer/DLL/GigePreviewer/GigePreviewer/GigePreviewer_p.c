...
/* Object interface: IPreview, ver. 0.0,
   GUID={0xc1a49bb6,0x4372,0x4a35,{0x92,0xea,0x7a,0x0f,0x54,0xb4,0x1b,0xd1}} */
...
static const MIDL_SERVER_INFO IPreview_ServerInfo = 
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(10) _IPreviewProxyVtbl = 
{
    &IPreview_ProxyInfo,
    &IID_IPreview,
    ...
    (void *) (INT_PTR) -1 /* IPreview::get_Radius */ ,
    (void *) (INT_PTR) -1 /* IPreview::put_Radius */ ,
    (void *) (INT_PTR) -1 /* IPreview::GetArea */
};


static const PRPC_STUB_FUNCTION IPreview_table[] =
{
